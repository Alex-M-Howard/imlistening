...
public class ImlisteningApplication {
    ...
    public class WebhookController {
        ...
        public WebhookController(WebClient webClient) {
        ...
        public Mono<ResponseEntity<String>> handleWebhook(
            ...
            // Call the send function using WebClient
            return send(inputData)
                    .map(response -> ResponseEntity.ok(response));
        }

        private Mono<String> send(InputData data) {
            ...
            try {
                ...
                // Make the HTTP POST request using WebClient
...
// 					String response = send(inputData);

// 					// Return the response from the send function
// 					return ResponseEntity.ok(response);
// 			}

// 			private String send(InputData data) {
// 					System.out.println(data.getUserInput());
// 					try {
// 							JsonArray messages = new JsonArray();
